   ...
   const fetchUserProfile = async () => {
    try {
        ...
        const response = await axios.get(
            `https://orbit-backend-94nx.onrender.com/api/Post/user/${id}`,
            {
                headers: {
                    Authorization:
    ...
    try {
        ...
        if (followStatus === "following") {
            ...
            await axios.put(
                `https://orbit-backend-94nx.onrender.com/api/Post/follow/${id}`,
                {},
                {
                    headers: {
                        Authorization:
        ...
        if (isPrivate) {
            ...
            await axios.post(
                `https://orbit-backend-94nx.onrender.com/api/Post/follow-request/${id}`,
                {},
                {
                    headers: {
                        Authorization:
